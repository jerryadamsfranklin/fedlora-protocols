...
details, per-seed results, statistical tests, a reproducibility checklist, and
cross-backend verification. Cross-references to the main paper use fixed table
and section numbers from the compiled manuscript.
