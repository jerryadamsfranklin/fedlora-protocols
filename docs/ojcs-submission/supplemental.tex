...
\begin{abstract}
This supplemental material provides hyperparameter details, per-seed results,
statistical tests, a reproducibility checklist, and cross-backend verification
for the main paper.
\end{abstract}
